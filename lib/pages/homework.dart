  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          IconButton(onPressed: (){}, icon: Icon(Icons.search),color: Colors.grey.shade400,),
          IconButton(onPressed: (){}, icon: Icon(Icons.camera_alt),color: Colors.grey.shade400,),
        ],
      ),
      body: ListView(
        children: [
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(userName,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.grey),),
                            Text(feedTime,style: TextStyle(fontSize: 15,color: Colors.grey.shade600),),
                          ],
                        )
                      ],
                    ),
